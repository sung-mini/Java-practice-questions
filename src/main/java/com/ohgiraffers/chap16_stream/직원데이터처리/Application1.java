package com.ohgiraffers.chap16_stream.직원데이터처리;
...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        List<String> highSalaryIT = employees.stream()
                .filter(e -> "IT".equals(e.getDepartment()) && e.getSalary() >= 5000)
        ...
        Map<String, Double> averageSalaryByDept = employees.stream()
                .collect(Collectors.groupingBy(Employee::getDepartment, Collectors.averagingDouble(Employee::getSalary)));// 코드 작성
